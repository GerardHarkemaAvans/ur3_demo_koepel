...
class pick_n_placeSM(Behavior):
	...
	def create(self):
		...
		_state_machine.userdata.frames = ["world" , "object_to_grasp"]
		...
		with _state_machine:
			...
			OperatableStateMachine.add('select_vaccum_gripper_1',
										SelectState(),
										transitions={'true': 'turn_vacuum_on', 'false': 'post_pick'},
			...
			OperatableStateMachine.add('select_vaccum_gripper_2',
										SelectState(),
										transitions={'true': 'turn_vacuum_off', 'false': 'go_resting'},
										autonomy={'true': Autonomy.Off, 'false': Autonomy.Off},
										remapping={'select': 'use_vacuum_gripper'})
			...
			OperatableStateMachine.add('take_pcl_photo',
										...
										transitions={'continue': 'pre_pick', 'failed': 'failed'},
